...
# ========================================
   def SetValue(self,Height,Distance,Direction, NewValue):
      GIndex =   self.BallDirection.index(Direction)*len(self.DistanceValues)*len(self.HeightValues) + self.HeightValues.index(Height)*len(self.DistanceValues) + self.DistanceValues.index(Distance)
...
# ========================================
   def DisplayGenome(self):
      ...
      for rowi in range(len(self.HeightValues)):
         ...
         for hdri in range(len(self.DistanceValues)): 
             rowstring = rowstring + self.PongGN[len(self.HeightValues)*len(self.DistanceValues) + rowi*len(self.DistanceValues)+ hdri] + "\t"
...
# ======================================== 
   def DisplayFlat(self):
      ...
      for rowi in range(len(self.HeightValues)):
         for hdri in range(len(self.DistanceValues)): 
            GString = GString + self.PongGN[len(self.HeightValues)*len(self.DistanceValues) + rowi*len(self.DistanceValues)+ hdri]
